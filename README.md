...
> 平時進行翻譯、程式範例、公式範例...等提問，個人會習慣使用 3.5，若遇到思考上或是情境問題，則會切換成 4.0 使用 (4.0 較具思考能力，但回答速度也會比較慢，而且官方有限制使用次數)。
...
> 如果您想恢復系統預設值的話，可以下載這個 [設定檔](https://drive.google.com/file/d/1e8xce9y_e-hRZM-vuOGl7izudB0JVAOI/view?usp=sharing) 進行復原，預計會在 0.3.0 版推出恢復系統預設值功能。

## 使用範例分享

ChatGPT 雖厲害，但也有其極限，所以我們要加強自己的判斷力，才能更好地利用與辨別 ChatGPT 的回答。此外，使用恰當的提示詞，也可以幫助我們更有效使用 ChatGPT 喔！
